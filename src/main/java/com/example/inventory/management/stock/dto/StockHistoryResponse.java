...
import com.example.inventory.management.stock.StockHistory;
import com.example.inventory.management.stock.StockType;
import io.swagger.v3.oas.annotations.media.Schema;

import java.time.Instant;

public record StockHistoryResponse(
        @Schema(description = "이력 ID. 상품별로 실제 반영 순서와 같다", example = "1") Long id,
